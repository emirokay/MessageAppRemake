...
struct MockData {
	...
	static let mocChat = Chat(id: "1", type: .individual, name: "john doe", imageUrl: "", memberIds: [mocUser.id, mocUser2.id], lastMessage: "Hey, how are you?", lastMessageBy: mocUser.id, lastMessageAt: Date(), createdBy: "1", createdAt: Date(), bio: "This is bio", admins: [mocUser.id], isPinned: [mocUser.id], isMuted: [mocUser.id], isRead: [mocUser.id], unreadCount: 0, messages: [mocMessage,mocMessage2])
	
	static let mocChat2 = Chat(id: "2", type: .individual, name: "Bruce Wayne", imageUrl: "", memberIds: [mocUser.id, mocUser2.id], lastMessage: "Test Message", lastMessageBy: mocUser2.id, lastMessageAt: Date(), createdBy: "1", createdAt: Date(), bio: "This is bio", admins: [mocUser.id], isPinned: [mocUser.id], isMuted: [mocUser.id], isRead: [mocUser.id], unreadCount: 2, messages: [mocMessage,mocMessage2])
