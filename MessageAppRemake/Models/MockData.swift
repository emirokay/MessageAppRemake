...
struct MockData {
	...
	static let mocChat = Chat(id: "1", type: .individual, name: "John Doe", imageUrl: "https://example.com/profile.jpg", members: [mocUser.id: mocUser.name, mocUser2.id: mocUser2.name], memberIds: [mocUser.id, mocUser2.id], lastMessage: "Hey, how are you?", lastMessageBy: mocUser.id, lastMessageAt: Date(), isPinned: true, isMuted: true, isRead: false, unreadCount: 2, messages: [mocMessage,mocMessage2])
	
	static let mocChat2 = Chat(id: "2", type: .individual, name: "Bruce Wayne", imageUrl: "https://example.com/profile.jpg", members: [mocUser.id: mocUser.name, mocUser2.id: mocUser2.name], memberIds: [mocUser.id, mocUser2.id], lastMessage: "Test Message", lastMessageBy: mocUser2.id, lastMessageAt: Date(), isPinned: true, isMuted: true, isRead: false, unreadCount: 2, messages: [mocMessage,mocMessage2])
